"""
Django settings for trustflow_test project.
...
DATABASES = {
    "default": {
        ...
        "NAME": os.getenv("USER_SERVICE_DB_NAME"),
        "USER": os.getenv("USER_SERVICE_DB_USER"),
        "PASSWORD": os.getenv("USER_SERVICE_DB_PASSWORD"),
        # 'HOST': os.getenv('USER_SERVICE_DB_HOST'), # docker
        "HOST": "localhost",  # local
        "PORT": os.getenv("USER_SERVICE_DB_PORT"),  # local
        # "PORT": 5432  # docker
    }
}
